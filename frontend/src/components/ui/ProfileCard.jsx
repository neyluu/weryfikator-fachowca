...
function ProfileCard({ data, contactButton = false, id = 0 }) {
    ...
    <div className="w-full border border-neutral-700 bg-neutral-900 rounded-3xl p-6 flex flex-col gap-3">
      <div className="flex flex-col justify-between gap-3">
        <div className="flex flex-col md:flex-row gap-6 justify-between items-start">
          ...
          <div className="flex flex-col gap-3 w-full md:w-auto items-start md:items-end bg-neutral-800/30 md:bg-transparent p-4 md:p-0 rounded-2xl border border-neutral-800 md:border-transparent">
            <div className="flex items-center gap-3">
              <Mail className="w-5 h-5 text-brand" />
              <p className="text-neutral-200">{profile.email || user.email}</p>
            </div>

            {profile.phoneNumber && (
              <div className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-brand" />
                <p className="text-neutral-200">{profile.phoneNumber}</p>
              </div>
            )}
      ...
      <div className="py-2 flex flex-col gap-2 border-t border-neutral-800 mt-2">
